...
Public NotInheritable Class Bienvenida
    ...
    Private Sub Bienvenida_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Copyright.Text = "Creado por Ivana Y. Currá ( " & My.Application.Info.Copyright & " )"
        Me.RelojBienvenida.Start()
    End Sub

    Private Sub RelojBienvenida_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RelojBienvenida.Tick
        Me.Close()
        Me.RelojBienvenida.Stop()
